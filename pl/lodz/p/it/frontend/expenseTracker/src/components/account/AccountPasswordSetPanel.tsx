        ...
        <div style={containerStyle} className="font-link">
            <Box sx={boxStyle}>
                ...
                <div style={headerTextStyle}>
                    {t('accountPasswordSetPanel.accountPasswordSet')}
                </div>
                ...
                <List style={listStyle}>
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                        <ListItem>
                            <div>
                                {t('accountPasswordSetPanel.accountPasswordSetDescription')}
                            </div>
                        </ListItem>
                    </div>
                        ...
                        <ListItemButton onClick={() => navigate('/login')}>
                            <ListItemText>
                                <div className="font-link" style={buttonTextStyle}>
                                    {t('accountPasswordSetPanel.login')}
                                </div>
                            </ListItemText>
                        </ListItemButton>
                    </ListItem>
...
export default AccountPasswordSetPanel;